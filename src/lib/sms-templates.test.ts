...
describe("sms templates", () => {
  it("renders the one-time invitation SMS with opt-out language", () => {
    expect(
      ...
      "Avery invited you to join MeshyLinks and connect on the platform. Create your account here: https://meshylinks.com/invite/test Reply STOP to opt out.",
    );
  });
  ...
  it("renders the connection request SMS with opt-out language", () => {
    expect(
      ...
      "Avery requested to connect with you on MeshyLinks. Review and approve here: https://meshylinks.com/connections/test Reply STOP to opt out.",
    );
  });
